...
def_area = createResArea(area_ID="Kongo",
                         ...
                         llC=-15E5,urC=15E5)
scene_proj = scene.resample(def_area)

# 4. Save both loaded composites of the resampled Scene as simple png images. [2P]

scene_projl.show("natural_color").save(plot_dir / Path("Nat_C.png"))
scene_proj.show("convection").save(plot_dir / Path("convection.png"))
